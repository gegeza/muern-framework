package com.muern.framework.encrypt;
...
import com.muern.framework.utils.ByteUtil;
...
public final class RsaKey {
    ...
    public static PrivateKey getPriKeyFromPfx(String path, String strPassword) {
        try (
            ...
            char[] nPassword = StringUtils.isEmpty(strPassword) ? null : strPassword.toCharArray();
